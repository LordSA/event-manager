...
* **Google Calendar Booking Engine:** `./app/components/GoogleCalendarView.tsx` supports Month, Week, Day, and Grid view modes. Features:
  ...
  - **Grid View Card Lift & Workspace Centering:** Selected/hovered cards in Grid View elevate smoothly above surrounding cards (`hover:-translate-y-1.5 z-10 hover:shadow-2xl`). Modal popups use `md:pl-64` layout offset on admin views to center modal cards relative to the main content workspace (center screen without sidebar).

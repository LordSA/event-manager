...
* **Closed Slot View Privacy Guard:** In `./app/components/GoogleCalendarView.tsx`, public event page links (`/events/[id]`) are strictly hidden for draft (`closed`) slots to prevent unauthorized viewing of unpublished reserved slots.

...
* **Glassmorphism Mobile Navigation:** `./app/components/AdminSidebar.tsx` renders a desktop sticky sidebar (`md:flex`) and a floating glassmorphic bottom navigation bar (`md:hidden fixed bottom-3 bg-[#0f121d]/75 backdrop-blur-2xl border-[#1e2436]/90`) for mobile touch devices, accompanied by a clean top header and `pb-28 md:pb-8` main view padding.

...
* **Bug Reporting & Support Portal:**
  - `./app/support/page.tsx`: Public bug reporting and support page asking for Name, Email, Phone, Issue Founded description, Screenshot/Proof upload or URL, and Suggestions/Feedback. Submit inserts into Supabase `support_tickets` table. Linked from `./app/components/Footer.tsx`.

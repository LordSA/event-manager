...
import { Globe, Mail, Coffee, Heart, Copy, Check, ExternalLink, Sparkles } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto space-y-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
          ...
          <div className="md:col-span-7 brutalist-card p-6 rounded-2xl bg-[#0f121d] border border-[#1e2436] space-y-5 relative">
            <div className="flex flex-wrap items-center justify-between gap-4 pb-4 border-b border-[#1e2436]">
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  <h4 className="text-sm font-bold text-white font-heading">Developed & Maintained By</h4>
                </div>
                <p className="text-xs text-white font-semibold flex items-center gap-1.5 flex-wrap">
                  Shibili Aman TK
                  <span className="text-[10px] text-[#6366f1] bg-[#6366f1]/10 px-2 py-0.5 rounded border border-[#6366f1]/20 font-mono">
                    Developer
                  </span>
                </p>
              </div>
              ...
              <div className="flex items-center gap-2">
                <a
                  ...
                  className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl bg-amber-500/10 hover:bg-amber-500/20 text-amber-400 border border-amber-500/30 hover:border-amber-400 text-xs font-bold transition-all shadow-sm active:scale-95 group"
                >
                ...
                <button
                  ...
                  className="px-2.5 py-2 rounded-xl bg-[#161a29] hover:bg-[#1e2436] text-xs text-[#94a3b8] hover:text-white border border-[#1e2436] transition-colors"
                  title="View UPI ID"
                >
                  UPI Info
                </button>
            ...
            {showQrModal && (
              <div className="p-3 bg-[#161a29] border border-[#1e2436] rounded-xl text-xs space-y-2 animate-in fade-in slide-in-from-top-2 duration-200">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-1">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 p-2.5 rounded-xl bg-[#161a29] hover:bg-[#1e2436] border border-[#1e2436] hover:border-[#6366f1]/50 text-xs text-[#f8fafc] transition-all group"
              >
                ...
                <span className="truncate font-medium">LordSA</span>
              </a>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 p-2.5 rounded-xl bg-[#161a29] hover:bg-[#1e2436] border border-[#1e2436] hover:border-[#3b82f6]/50 text-xs text-[#f8fafc] transition-all group"
              >
                <svg className="w-4 h-4 fill-current text-[#3b82f6] group-hover:text-white transition-colors" viewBox="0 0 24 24">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 p-2.5 rounded-xl bg-[#161a29] hover:bg-[#1e2436] border border-[#1e2436] hover:border-[#10b981]/50 text-xs text-[#f8fafc] transition-all group"
              >
                <Globe className="w-4 h-4 text-[#10b981] group-hover:text-white transition-colors" />
                <span className="truncate font-medium">Website</span>
              </a>

              <a
                href="mailto:shibiliamantk@gmail.com"
                className="flex items-center gap-2 p-2.5 rounded-xl bg-[#161a29] hover:bg-[#1e2436] border border-[#1e2436] hover:border-[#ec4899]/50 text-xs text-[#f8fafc] transition-all group"
              >
                <Mail className="w-4 h-4 text-[#ec4899] group-hover:text-white transition-colors" />
                <span className="truncate font-medium">Connect Me</span>
              </a>
            </div>
          </div>
        </div>

        <div className="pt-6 border-t border-[#1e2436] flex flex-col sm:flex-row items-center justify-between gap-4 text-xs">
          <p className="flex items-center gap-1.5 text-[#94a3b8]">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-white hover:text-[#6366f1] font-semibold transition-colors underline decoration-[#1e2436] underline-offset-4"
            >
              Shibili Aman TK
            </a>
          </p>

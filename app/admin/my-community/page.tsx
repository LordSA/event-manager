  ...
  return (
    <div className="max-w-4xl space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#1e2436] pb-4">
        ...
        <div className="flex items-center space-x-2 px-3 py-1.5 rounded-lg bg-[#161a29] border border-[#1e2436] text-xs font-semibold text-[#94a3b8] w-fit">
          {isEditable ? <Edit2 className="w-3.5 h-3.5 text-[#6366f1]" /> : <Eye className="w-3.5 h-3.5 text-emerald-400" />}
      ...
      <div className="brutalist-card p-6 rounded-xl space-y-6">
        <div className="flex items-center space-x-4 border-b border-[#1e2436] pb-4">
          ...
          <div>
            ...
            <p className="text-xs text-[#94a3b8] font-mono mt-0.5">slug: {community.slug}</p>
          </div>
        </div>

...
export default function EventPage() {
  ...
  return (
    <div className="flex h-screen bg-[#050505] text-white font-sans overflow-hidden selection:bg-blue-500 selection:text-white">
      ...
      <div className="w-full md:w-[400px] lg:w-[450px] border-r border-gray-800 bg-[#0A0A0A] p-6 hidden md:flex flex-col h-full overflow-y-auto scrollbar-hide" data-lenis-prevent>
      ...
      <div className="flex-1 flex flex-col bg-[#050505] relative">
        ...
        <div 
          className="flex-1 overflow-y-auto scrollbar-hide p-4 md:p-8 space-y-6 pt-16 md:pt-8" 
          data-lenis-prevent
        >
          {chatLog.length === 0 && (
